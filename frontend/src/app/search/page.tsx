    ...
    <div className="min-h-screen bg-slate-50 py-16"> 
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto mb-10 text-center"> 
          <h1 className="text-4xl font-semibold text-gray-900 mb-4">Natural Language Code Search</h1> 
          ...
          <div className="mb-10 bg-gradient-to-r from-blue-50 to-indigo-50 border border-indigo-100 p-6 rounded-xl text-left shadow-sm"> 
            <div className="flex items-start">
              ...
              <div>
                <h3 className="font-semibold text-blue-800 mb-3 text-base">Search Tips</h3> 
            ...
            <div className="bg-gradient-to-r from-red-50 to-rose-50 rounded-xl shadow-md border border-red-100 p-6 mb-10 text-left"> 
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="mt-3 text-gray-700">Please check your query and try again.</p>
                </div>
              </div>
            </div>
          )}
          ...
          {results.length > 0 || isLoading ? (
            ...
            <div className="text-center py-20 px-6 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl shadow-md border border-indigo-100"> 
              <div className="flex flex-col items-center text-center">
                ...
                <h2 className="text-xl font-medium text-gray-800 mb-3">Start Searching</h2> 
                <p className="text-gray-600 max-w-md mx-auto text-sm leading-relaxed"> 
                  Enter a natural language query above to find relevant code snippets from GitHub. 
                  <br /> For example: "React hooks for form validation" or "async file handling in Node.js"
                </p>
              </div>
            </div>
          ) : !error && (
            ...
            <div className="text-center py-20 px-6 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl shadow-md border border-indigo-100"> 
              <div className="flex flex-col items-center text-center">
                ...
                <h2 className="text-xl font-medium text-gray-800 mb-3">No Results Found</h2> 
